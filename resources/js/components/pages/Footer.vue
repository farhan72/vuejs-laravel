<template>
    <div
        class="jumbotron footer mb-0 bg-dark rounded-0 d-flex align-items-center"
    >
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3 footer-content">
                    ...
                    <ul>
                        <li>
                            <a href="https://www.niagahoster.co.id/domain-murah"
                                >Domain</a
                            >
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="https://www.niagahoster.co.id/ssl-murah"
                        ...
                        <li>
                            <a href="https://www.niagahoster.co.id/afiliasi"
                                >Program Afiliasi</a
                            >
                        </li>
                    </ul>
                    ...
                    <ul>
                        <li class="form-newsletter">
                            <input
                                type="text"
                                placeholder="Email"
                                class="form-control rounded-pill col-md-12"
                            />
